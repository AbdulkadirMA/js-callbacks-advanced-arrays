...
const runnersFirstName=[]
let largeShirts = runners.filter(function(item){
   if(item.shirt_size >"XL") {
     runnersFirstName.push(item.first_name)
   }
});
console.log(runnersFirstName);
...
const ticketPriceTotal=runners.reduce(function(acc,CurrentValue){
    console.log("This is Accumolator ", acc)
    console.log("This is Current value ", CurrentValue.donation)
},0)
